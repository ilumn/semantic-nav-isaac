...
- a FastAPI backend with browser-based 3D, video, and graph inspection interfaces
...
The backend entry point is [`semantic_nav_memory/server.py`](../semantic_nav_memory/server.py).
...
The orchestration layer is [`semantic_nav_memory/pipeline.py`](../semantic_nav_memory/pipeline.py).
...
The geometry backend is [`semantic_nav_memory/geometry_colmap.py`](../semantic_nav_memory/geometry_colmap.py).

It currently does the following:

- uses `pycolmap.extract_features`
- tries sequential video matching first and falls back to exhaustive matching only when needed
- runs incremental monocular mapping
- rejects weak reconstructions using registered-keyframe health checks
...
The detector backend is [`semantic_nav_memory/detector_yoloworld.py`](../semantic_nav_memory/detector_yoloworld.py).

It currently:

- loads one of the configured `YOLO-World` size variants
- sets a constrained prompt vocabulary
- batches prompts and tiles aerial or outdoor scenes for small-object recovery
- runs detection on extracted keyframes
- writes annotated preview frames

The default prompt set is defined in:

- [`semantic_nav_memory/config.py`](../semantic_nav_memory/config.py)
- [`semantic_nav_memory/prompts.yaml`](../semantic_nav_memory/prompts.yaml)
...
- [`semantic_nav_memory/tracker_2d.py`](../semantic_nav_memory/tracker_2d.py)
- [`semantic_nav_memory/grounder_3d.py`](../semantic_nav_memory/grounder_3d.py)
- [`semantic_nav_memory/entity_memory.py`](../semantic_nav_memory/entity_memory.py)
...
The ontology lives in [`semantic_nav_memory/ontology.yaml`](../semantic_nav_memory/ontology.yaml) and provides:
...
The current relation logic in [`semantic_nav_memory/relation_inference.py`](../semantic_nav_memory/relation_inference.py) emits:
...
- [`frontend/viewer.js`](../frontend/viewer.js)
